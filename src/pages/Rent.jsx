...
function Rent() {
  ...
  const filteredProperties = useMemo(() => {
    let result = rentProperties.filter(
      (property) => {
        const searchText =
  ...
  return (
    <main className="listing-page">
      ...
      <section className="listing-page-hero rent-page-hero">
        <div className="container">
          <div className="listing-page-heading">
            ...
            <p>
              Browse houses, flats, villas and
              commercial properties available
              for rent across Chhatarpur.
            </p>
          </div>
          ...
          <div className="listing-search-box">
            ...
            <input
              ...
              placeholder="Search rental property, area or type..."
